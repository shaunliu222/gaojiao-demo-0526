import type { TeachingDesign, TeachingDesignV2, DesignOutputV2 } from "./types";
...
// ========================================================================
// V2 教学设计数据
// 将 sec-3-2 的 4 个 Tab（讲义/课堂/作业/AI融合）合并为单一 TeachingDesignV2
// ========================================================================
export const teachingDesignsV2: TeachingDesignV2[] = [
  {
    id: "design-v2-sec-3-2",
    planId: "plan-main",
    lessonId: "lesson-plan-main-8",
...
/** 按 (planId, lessonId, classId) 查 V2 设计 */
export const designsByLessonV2 = new Map<string, TeachingDesignV2>(
  teachingDesignsV2.map(d => [`${d.planId}::${d.lessonId}::${d.classId ?? ""}`, d])
);
