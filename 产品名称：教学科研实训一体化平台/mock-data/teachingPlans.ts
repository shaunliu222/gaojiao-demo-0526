import type { TeachingPlan, TeachingPlanV2 } from "./types";
...
// ============================================================================
// v2.0 教学计划（6 个，与 v1 一一对应）
// ============================================================================

/** 知识图谱节点 ID → 名称映射 */
const knNameMap: Record<string, string> = {
  // Core (核心素养)
  "core-mech-001": "工程系统素养",
  "core-mech-002": "机械结构素养",
  "core-mech-003": "工程规范素养",
  "core-mech-004": "数字化协同素养",
  "core-mech-005": "协同实践素养",
  // Ability (能力)
  "sk-mech-001": "徒手与国标制图表达能力",
  "sk-mech-002": "AutoCAD 二维制图与出图能力",
  "sk-mech-003": "三维建模与装配出图能力",
  "sk-mech-004": "零件测绘与图样转化能力",
  "sk-mech-005": "工程读图与拆图表达能力",
  "sk-mech-006": "互换性与质量控制能力",
  "sk-mech-007": "工艺规范与安全意识能力",
  "sk-mech-008": "生成式 AI 辅助工程能力",
  "sk-mech-009": "形体组成与制图推理能力",
  "sk-mech-010": "投影线与空间推理能力",
  "sk-mech-011": "制造工艺入门能力",
  "sk-mech-012": "工业机器人与回路认知能力",
  // Knowledge (知识点)
  "kn-mech-001": "制图与国标注解基础",
  "kn-mech-002": "几何作图与测绘入门",
  "kn-mech-003": "投影原理与三视图体系",
  "kn-mech-004": "线面分析与回转体投影",
  "kn-mech-005": "组合体分析与视图表征",
  "kn-mech-006": "截交线与相贯线要点",
  "kn-mech-007": "机件表达策略",
  "kn-mech-008": "螺纹紧固与键销齿轮",
  "kn-mech-009": "零件图技术要求",
  "kn-mech-010": "装配图拆装与BOM语义",
  "kn-mech-011": "AutoCAD图层与版面出图",
  "kn-mech-012": "三维特征—装配—工程图",
  "kn-mech-013": "车铣制造工艺入门",
  "kn-mech-014": "工业机器人工作站与安全示教",
  "kn-mech-015": "液压气动典型回路与互锁认知",
  "kn-mech-016": "智能制造与孪生可视化入门",
  "kn-mech-017": "学科内生成式AI使用规范",
  "kn-mech-018": "专业图谱与路径意识",
  // Course
  "course-mech-draw": "机械制图与CAD",
  "course-mech-intro": "机械工程专业导论",
  "course-mech-tolerance": "互换性与技术测量",
  "course-mech-practice": "金工实习",
  "course-mech-robotics": "工业机器人技术应用基础",
  // Training
  "train-m-001": "徒手草图与测绘工作坊",
  "train-m-002": "组合体视图专项实训",
  "train-m-003": "AutoCAD齿轮轴实训",
  "train-m-004": "SolidWorks轴承座建模实训",
};

export const teachingPlansV2: TeachingPlanV2[] = [
  // ========================================================================
  // 1. 主线教学计划
  // ========================================================================
  {
    ...
    subjectId: "subj-mech-drawing",
    creatorTeacherId: "t-li",
    strategyTag: "strat-li-personal",
    customStrategy: "本班基础较弱，前5课时放慢节奏，多安排基础练习",
    strategyBrief:
      "结合 2301（踏实稳健）+ 2302（两极分化）+ 2303（理工动手、与机器人课联动）三班学情，前期夯实投影基础；当前重心已进入第 3 章组合体单元（下一堂主攻 3.2）。投影基础阶段曾放缓约 1 周并保留每周「3 分钟空间想象挑战」；2302 班额外安排课后答疑与分层补救，2303 班每周嵌入手绘与数模对照。预计平行班期末优良率 75%+，薄弱生不及格率控制在 8% 以内。",
    semester: "2026春季",
    startDate: "2026-02-23",
    ...
    lessons: [
      {
        id: "lesson-plan-main-1",
        planId: "plan-main",
        lessonNo: 1,
        date: "2026-02-23",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-001", "kn-mech-018"],
        knowledgePointNames: ["制图与国标注解基础", "专业图谱与路径意识"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-2",
        planId: "plan-main",
        lessonNo: 2,
        date: "2026-02-25",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-001", "kn-mech-009"],
        knowledgePointNames: ["制图与国标注解基础", "零件图技术要求"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-3",
        planId: "plan-main",
        lessonNo: 3,
        date: "2026-03-02",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-002", "kn-mech-003"],
        knowledgePointNames: ["几何作图与测绘入门", "投影原理与三视图体系"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-4",
        planId: "plan-main",
        lessonNo: 4,
        date: "2026-03-04",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-003", "kn-mech-004"],
        knowledgePointNames: ["投影原理与三视图体系", "线面分析与回转体投影"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-5",
        planId: "plan-main",
        lessonNo: 5,
        date: "2026-03-09",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-004", "kn-mech-005"],
        knowledgePointNames: ["线面分析与回转体投影", "组合体分析与视图表征"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-6",
        planId: "plan-main",
        lessonNo: 6,
        date: "2026-03-11",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-004"],
        knowledgePointNames: ["线面分析与回转体投影"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-8",
        planId: "plan-main",
        lessonNo: 8,
        date: "2026-03-18",
        durationMinutes: 135,
        knowledgePointIds: ["core-mech-002", "sk-mech-009", "sk-mech-010", "kn-mech-005", "course-mech-draw", "train-m-002"],
        knowledgePointNames: ["机械结构素养", "形体组成与制图推理能力", "投影线与空间推理能力", "组合体分析与视图表征", "机械制图与CAD", "组合体视图专项实训"],
        resourceIds: [],
        resourceTypes: [],
        aiNote: "建议先讲形体分析法再引入组合体三视图绘制，2302班需加强空间想象训练",
        status: "in_progress",
        hasDesign: true,
        objectives: ["掌握形体分析法", "完整绘制中等难度组合体三视图", "养成检查意识"],
      },
      {
        id: "lesson-plan-main-9",
        planId: "plan-main",
        lessonNo: 9,
        date: "2026-03-23",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-005", "kn-mech-009", "kn-mech-010"],
        knowledgePointNames: ["组合体分析与视图表征", "零件图技术要求", "装配图拆装与BOM语义"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-10",
        planId: "plan-main",
        lessonNo: 10,
        date: "2026-03-25",
        durationMinutes: 135,
        knowledgePointIds: ["kn-mech-006", "sk-mech-003"],
        knowledgePointNames: ["截交线与相贯线要点", "三维建模与装配出图能力"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-11",
        planId: "plan-main",
        lessonNo: 11,
        date: "2026-03-30",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-007", "kn-mech-008"],
        knowledgePointNames: ["机件表达策略", "螺纹紧固与键销齿轮"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-12",
        planId: "plan-main",
        lessonNo: 12,
        date: "2026-04-01",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-007"],
        knowledgePointNames: ["机件表达策略"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-13",
        planId: "plan-main",
        lessonNo: 13,
        date: "2026-04-06",
        durationMinutes: 135,
        knowledgePointIds: ["kn-mech-007", "kn-mech-010"],
        knowledgePointNames: ["机件表达策略", "装配图拆装与BOM语义"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-15",
        planId: "plan-main",
        lessonNo: 15,
        date: "2026-04-13",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-008"],
        knowledgePointNames: ["螺纹紧固与键销齿轮"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-16",
        planId: "plan-main",
        lessonNo: 16,
        date: "2026-04-15",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-008", "kn-mech-010"],
        knowledgePointNames: ["螺纹紧固与键销齿轮", "装配图拆装与BOM语义"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-17",
        planId: "plan-main",
        lessonNo: 17,
        date: "2026-04-20",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-008", "kn-mech-009"],
        knowledgePointNames: ["螺纹紧固与键销齿轮", "零件图技术要求"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-18",
        planId: "plan-main",
        lessonNo: 18,
        date: "2026-04-22",
        durationMinutes: 135,
        knowledgePointIds: ["kn-mech-009", "kn-mech-008", "kn-mech-015"],
        knowledgePointNames: ["零件图技术要求", "螺纹紧固与键销齿轮", "液压气动典型回路与互锁认知"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-19",
        planId: "plan-main",
        lessonNo: 19,
        date: "2026-04-27",
        durationMinutes: 135,
        knowledgePointIds: ["kn-mech-010", "kn-mech-009"],
        knowledgePointNames: ["装配图拆装与BOM语义", "零件图技术要求"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-20",
        planId: "plan-main",
        lessonNo: 20,
        date: "2026-04-29",
        durationMinutes: 135,
        knowledgePointIds: ["sk-mech-002", "kn-mech-011", "course-mech-draw", "train-m-003"],
        knowledgePointNames: ["AutoCAD 二维制图与出图能力", "AutoCAD图层与版面出图", "机械制图与CAD", "AutoCAD齿轮轴实训"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-main-21",
        planId: "plan-main",
        lessonNo: 21,
        date: "2026-05-04",
        durationMinutes: 135,
        knowledgePointIds: ["sk-mech-003", "kn-mech-012", "course-mech-draw", "train-m-004"],
        knowledgePointNames: ["三维建模与装配出图能力", "三维特征—装配—工程图", "机械制图与CAD", "SolidWorks轴承座建模实训"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
  ...
  // ========================================================================
  {
    ...
    subjectId: "subj-mech-drawing",
    creatorTeacherId: "t-li",
    strategyTag: "strat-preset-balanced",
    strategyBrief:
      "2201 班基础整体较好，使用均衡推进策略即可，重点放在零件图装配图综合阶段，课后增加 SolidWorks 建模拓展。",
    semester: "2025春季",
    startDate: "2025-02-24",
    ...
    lessons: [
      {
        id: "lesson-plan-history-1",
        planId: "plan-history",
        lessonNo: 1,
        date: "2025-02-24",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-001"],
        knowledgePointNames: ["制图与国标注解基础"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-history-2",
        planId: "plan-history",
        lessonNo: 2,
        date: "2025-03-19",
        durationMinutes: 135,
        knowledgePointIds: ["kn-mech-005", "core-mech-002"],
        knowledgePointNames: ["组合体分析与视图表征", "机械结构素养"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
  ...
  // ========================================================================
  {
    ...
    lessons: [
      {
        id: "lesson-plan-mech-intro-1",
        planId: "plan-mech-intro",
        lessonNo: 1,
        date: "2026-02-24",
        durationMinutes: 90,
        knowledgePointIds: ["core-mech-001", "kn-mech-014"],
        knowledgePointNames: ["工程系统素养", "工业机器人工作站与安全示教"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
        objectives: ["能描述本专业典型就业面向"],
      },
      {
        id: "lesson-plan-mech-intro-2",
        planId: "plan-mech-intro",
        lessonNo: 2,
        date: "2026-02-26",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-018", "kn-mech-003", "kn-mech-017"],
        knowledgePointNames: ["专业图谱与路径意识", "投影原理与三视图体系", "学科内生成式AI使用规范"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
        objectives: ["理解先修关系与能力递进"],
      },
      {
        id: "lesson-plan-mech-intro-3",
        planId: "plan-mech-intro",
        lessonNo: 3,
        date: "2026-03-03",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-002", "kn-mech-003", "kn-mech-004"],
        knowledgePointNames: ["几何作图与测绘入门", "投影原理与三视图体系", "线面分析与回转体投影"],
        resourceIds: [],
        resourceTypes: [],
        status: "in_progress",
        hasDesign: false,
        objectives: ["认识图线、字体与比例"],
      },
    ],
    createdAt: "2026-02-14T14:00:00+08:00",
    updatedAt: "2026-04-14T16:00:00+08:00",
  ...
  // ========================================================================
  {
    ...
    lessons: [
      {
        id: "lesson-plan-mech-tolerance-1",
        planId: "plan-mech-tolerance",
        lessonNo: 1,
        date: "2026-02-24",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-009", "kn-mech-015", "kn-mech-017"],
        knowledgePointNames: ["零件图技术要求", "液压气动典型回路与互锁认知", "学科内生成式AI使用规范"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-mech-tolerance-2",
        planId: "plan-mech-tolerance",
        lessonNo: 2,
        date: "2026-02-26",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-009", "sk-mech-006", "kn-mech-015"],
        knowledgePointNames: ["零件图技术要求", "互换性与质量控制能力", "液压气动典型回路与互锁认知"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-mech-tolerance-3",
        planId: "plan-mech-tolerance",
        lessonNo: 3,
        date: "2026-03-10",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-009"],
        knowledgePointNames: ["零件图技术要求"],
        resourceIds: [],
        resourceTypes: [],
        status: "in_progress",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-mech-tolerance-4",
        planId: "plan-mech-tolerance",
        lessonNo: 4,
        date: "2026-03-12",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-009", "kn-mech-015", "train-m-004"],
        knowledgePointNames: ["零件图技术要求", "液压气动典型回路与互锁认知", "SolidWorks轴承座建模实训"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
  ...
  // ========================================================================
  {
    ...
    lessons: [
      {
        id: "lesson-plan-wang-metalwork-1",
        planId: "plan-wang-metalwork",
        lessonNo: 1,
        date: "2026-03-03",
        durationMinutes: 60,
        knowledgePointIds: ["kn-mech-009", "core-mech-001"],
        knowledgePointNames: ["零件图技术要求", "工程系统素养"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-wang-metalwork-2",
        planId: "plan-wang-metalwork",
        lessonNo: 2,
        date: "2026-03-05",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-009", "kn-mech-015", "kn-mech-003"],
        knowledgePointNames: ["零件图技术要求", "液压气动典型回路与互锁认知", "投影原理与三视图体系"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: true,
      ...
      {
        id: "lesson-plan-wang-metalwork-3",
        planId: "plan-wang-metalwork",
        lessonNo: 3,
        date: "2026-03-12",
        durationMinutes: 120,
        knowledgePointIds: ["kn-mech-009", "kn-mech-010", "train-m-004"],
        knowledgePointNames: ["零件图技术要求", "装配图拆装与BOM语义", "SolidWorks轴承座建模实训"],
        resourceIds: [],
        resourceTypes: [],
        status: "in_progress",
        hasDesign: false,
      ...
      {
        id: "lesson-plan-wang-metalwork-4",
        planId: "plan-wang-metalwork",
        lessonNo: 4,
        date: "2026-03-14",
        durationMinutes: 120,
        knowledgePointIds: ["kn-mech-010", "kn-mech-011"],
        knowledgePointNames: ["装配图拆装与BOM语义", "车铣制造工艺入门"],
        resourceIds: [],
        resourceTypes: [],
        status: "planned",
        hasDesign: false,
  ...
  // ========================================================================
  {
    ...
    lessons: [
      {
        id: "lesson-plan-mech-robotics-1",
        planId: "plan-mech-robotics",
        lessonNo: 1,
        date: "2026-03-02",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-014", "kn-mech-010", "core-mech-003"],
        knowledgePointNames: ["工业机器人工作站与安全示教", "装配图拆装与BOM语义", "工程规范素养"],
        resourceIds: [],
        resourceTypes: [],
        status: "completed",
        hasDesign: false,
        objectives: ["能口述安全互锁逻辑"],
      },
      {
        id: "lesson-plan-mech-robotics-2",
        planId: "plan-mech-robotics",
        lessonNo: 2,
        date: "2026-03-05",
        durationMinutes: 90,
        knowledgePointIds: ["kn-mech-014", "kn-mech-012", "kn-mech-016", "train-m-004"],
        knowledgePointNames: ["工业机器人工作站与安全示教", "三维特征—装配—工程图", "智能制造与孪生可视化入门", "SolidWorks轴承座建模实训"],
        resourceIds: [],
        resourceTypes: [],
        status: "in_progress",
        hasDesign: false,
