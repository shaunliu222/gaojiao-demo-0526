...
export const classProfiles: ClassProfile[] = [
  {
    ...
    styleTag: "踏实稳健型",
    aiSummary:
      "机制 2301 班整体学情中上，基础知识与绘图规范掌握较好，作业按时率达 96%。班级已进入第 3 章组合体单元：刚结束 3.1 平面立体与回转体投影，下一堂主攻 3.2 组合体三视图；后续截交线与相贯线仍是预测薄弱带，建议配合 3D 模型观察与多案例练习。班级学风踏实、讨论氛围良好，建议沿用渐进式节奏，每章引入 1-2 个工程情境案例激发主动探究。",
    generatedAt: "2026-03-10T09:00:00+08:00",
    generatedBy: "ai",
    progressSectionId: "sec-3-1",
    designReviewSectionIds: ["sec-3-1", "sec-2-4"],
  },
  {
    ...
    styleTag: "两极分化型",
    aiSummary:
      "机制 2302 班呈明显两极分化，标准差 15.2（全校同类课程基线 9.5）。前 5 名学生已具备工程师思维；后段学生在投影基础阶段薄弱，当前班级进度已到第 3 章——刚讲完 3.1，次日课堂聚焦 3.2 组合体三视图，需在轴承座案例中嵌入针对性补救。建议分层教学：基础班补课主攻「三视图对应规律」并在 3.2 课堂嵌入短时口诀回放；提高班增加开放型综合题与 SolidWorks 建模实训；全班共享同一教学计划但按层布置作业。",
